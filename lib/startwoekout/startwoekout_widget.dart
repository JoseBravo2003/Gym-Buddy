...
import 'startwoekout_model.dart';
export 'startwoekout_model.dart';

class StartwoekoutWidget extends StatefulWidget {
  const StartwoekoutWidget({super.key});

  @override
  State<StartwoekoutWidget> createState() => _StartwoekoutWidgetState();
}

class _StartwoekoutWidgetState extends State<StartwoekoutWidget> {
  late StartwoekoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StartwoekoutModel());
                          ...
                          children: [
                            FFButtonWidget(
                              ...
                              text: FFLocalizations.of(context).getText(
                                '5ugne24g' /* Empezar un nuevo ejercicio */,
                              ),
